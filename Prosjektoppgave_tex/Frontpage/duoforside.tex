...
\newcommand{\duoforside}[1][]{{%
  ...
  \setkeys{duo@keys}{#1}
  \duo@page@i {\if@twoside \duo@blankpage \fi} 
  \setcounter{page}{1}
  \@ifundefined{hypersetup}{}{\hypersetup{pageanchor=true}}
}}
%\duo@blankpage | \duo@page@ii \duo@page@iii {\if@twoside \duo@blankpage \fi} | \duo@page@i \duo@page@iv
...
\newcommand{\duo@page@i}{%
  \begin{titlepage}
    ...
    \includegraphics[width=6cm]{Frontpage/DUO_UiO_segl}\par
...
\newcommand{\subtitlee}[1]{\def \duo@subtitle{#1}}
\subtitlee{}
